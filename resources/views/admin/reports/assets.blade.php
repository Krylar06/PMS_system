...
<div class="space-y-5">
    <div class="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Filtered by device type, office, and college.</p>
        </div>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
        <form method="GET" class="grid grid-cols-1 gap-3 lg:grid-cols-5">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('admin.reports.assets') }}" class="rounded-xl bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200">Reset</a>
            </div>
        </form>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse($devices as $device)
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 font-medium text-blue-700">
                                <a href="{{ route('admin.devices.show', $device) }}" class="hover:underline">{{ $device->property_number }}</a>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="10" class="px-6 py-8 text-center text-gray-500">No assets found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
